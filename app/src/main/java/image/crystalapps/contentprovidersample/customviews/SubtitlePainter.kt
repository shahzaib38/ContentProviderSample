package image.crystalapps.contentprovidersample.customviews
...
internal class SubtitlePainter(context: Context) {
    ...
    private var cueTextAlignment: Layout.Alignment? = null
    ...
    private fun setupTextLayout() {
        ...
        val textAlignment = if (cueTextAlignment == null) Layout.Alignment.ALIGN_CENTER else cueTextAlignment
