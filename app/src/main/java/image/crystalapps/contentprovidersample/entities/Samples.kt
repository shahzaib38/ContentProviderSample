...
object Samples {
    ...
    init {
        ...
        videoSamples.add(Samples.Sample("TikTok", "content://media/external/images/media/9782")
        )

 //       videoSamples.add(Sample("FLV - Big Buck Bunny by Blender", "https://archive.org/download/Popeye_forPresident/Popeye_forPresident_512kb.mp4"))
