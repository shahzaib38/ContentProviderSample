package image.crystalapps.contentprovidersample.api
...
class VideoApi(var videoView: VideoView)  :BaseMediaApi() ,PlaylistListener<MediaItem> {
    ...
    override fun onPlaybackStateChanged(playbackState: com.devbrackets.android.playlistcore.data.PlaybackState): Boolean {
        return false
    }
