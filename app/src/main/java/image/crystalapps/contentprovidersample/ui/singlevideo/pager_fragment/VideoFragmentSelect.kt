...
import kotlinx.android.synthetic.main.video_select_layout.*

@AndroidEntryPoint
class VideoFragmentSelect  : BaseFragment<SingleVideoPlayerViewModel , VideoSelectDataBinding>() ,VideoControlsSeekListener{
